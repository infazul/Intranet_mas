<?php
    ...
    if (!empty($_POST['rut']) && !empty($_POST['password']) && !empty($_POST['primer_nombre'] && !empty($_POST['primer_apellido']) ) ){
        ...
        $sql = "INSERT INTO usuarios (rut, password, perfil, primer_nombre, segundo_nombre, primer_apellido, segundo_apellido ) VALUES (:rut, :password, :perfil, :primer_nombre, :segundo_nombre, :primer_apellido, :segundo_apellido)";
